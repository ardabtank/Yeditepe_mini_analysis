...
class DataProcessor:
    ...
    def balance_data(self):
        ...
        # Satır sayısı ve örneklerin txt dosyasına kaydedilmesi
    ...
    def check_intersections(self, X_train, X_val, X_test):
      ...
      with open('checking.txt', 'w') as file:
            file.write(f"Train-Val Instersection: {len(train_val_intersection)}\n\n")
      with open('checking.txt', 'w') as file:
            file.write(f"Train-Test Instersection: {len(train_test_intersection)}\n\n")
      with open('checking.txt', 'w') as file:
            file.write(f"Val-Test Instersection: {len(val_test_intersection)}\n\n")
...
# ***Creating another prediction with X_test data which is unseen by the model.
