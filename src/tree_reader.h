...
// Mon Mar  4 20:24:42 2024 by ROOT version 6.30/04
// from TTree mini/mini
// found on file: data_D.3lep.root
//////////////////////////////////////////////////////////
...
public :
   ...
   //Serhat : bunu ben ekledim
   // içine yazacağımız bir output root file olsun...
...
tree_reader::tree_reader(TTree *tree) : fChain(0) , m_destination("default_dest.root")
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data_D.3lep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data_D.3lep.root");
      }
