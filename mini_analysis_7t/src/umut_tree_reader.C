...
if(DATA_MC_CHECK == 0){
    for (int counter = 0; counter < lep_n; counter++)
    {
      if ((*lep_type)[counter] == 11)
      {
        if( ((*lep_pt)[counter] / 1000.0)>25.0 && (*lep_ptcone30)[counter]<0.15 && (*lep_etcone20)[counter]<0.15){
          //((*lep_pt)[counter] / 1000.0)>25.0 && (*lep_ptcone30)[counter]<0.15 && (*lep_etcone20)[counter]<0.15)
        electron_count += 1;
